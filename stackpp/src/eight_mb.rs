...
const EXCEPTION_ZONE: usize = 8 * 4096;
...
impl Stack for EightMbStack {
    ...
    fn new() -> Result<Self, Error> {
        unsafe {
            // Add extra 16 Kb on top of the stack to be used by the exception handler in case of stack overflow.
            ...
            let ptr_bottom_1 = ptr.add(EIGHT_MB + EXCEPTION_ZONE - 2 * 4096);
    ...
    fn bottom(&self) -> *mut usize {
        ...
        unsafe { self.0.add((EIGHT_MB + EXCEPTION_ZONE - 4096)/ size_of::<usize>()) }
    }
